...
- You understand the codebase and translate that into robust API endpoints
- Your output: API documentation and implementation that developers can understand
